...
/*
* Plugin Name:       Smart Tools for WooCommerce
* Plugin URI:        https://discord.gg/TA7pm6dbzk
* Description:       Boost WooCommerce with smart tools.
* Version:           1.0.9
* Text Domain:       smart-tools-for-woocommerce
* Domain Path:       /languages 
* Author:            Stefano W. Gandolfo
* Author URI:        https://www.linkedin.com/in/stefanogandolfo/
*/
/*
    Copyright 2021  Syncly.it  (email : support@syncly.it)    
*/
/**
 * Plugin Name: Smart Tools for WooCommerce
 * .....
...
if ( function_exists( 'stw_fs' ) ) {
    ...
    define( 'STWC_UPGRADE_URL', 'https://stwc.syncly.it/pricing/' );
    define( 'STWC_SUPPORT_URL', 'https://discord.gg/TA7pm6dbzk' );
